...
public class Global {
	...
	public boolean inDebugMode() {
		...
		try {
			isDebugging = java.lang.management.ManagementFactory.getRuntimeMXBean()
	...
	private synchronized String parseAppVersion() {
		...
		String appVersion = APP_REVISION.replaceAll("\\$Revision: ", "")
				.replaceAll("\\$Rev: ", "").replaceAll(" \\$", "");
	...
	/**
	 * Override the built-in version numbering and use the embedded version tag instead.
	 *
	 * @param version The version designation to use or NULL to parse internally.
	 */
